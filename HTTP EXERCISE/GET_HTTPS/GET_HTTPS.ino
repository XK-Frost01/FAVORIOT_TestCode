/* This code is about using rpc on rest api (http protocol) and GET method to receive data from the
 * favoriot platform to hibiscus sense.
 * Feature from Hibiscus sense used here is:
     1. LED
     2. RGB
     3. BUZZER
 * Additional feature add using widget form favoriot platform is:
     1. color control in RGB
     2. song playlist using buzzer 
 */
